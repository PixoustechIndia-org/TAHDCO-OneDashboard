...
import { SchemeReportComponent } from './scheme-report.component';
...
describe('SchemeReportComponent', () => {
  ...
  it('should open dialog with row data', () => {
    const row = { division: 'Chennai', district: 'Kanchipuram', scheme: 'Land Purchase Loan', project: 'TELP', value: 100 };
    component.openRowDetail(row);
    expect(component.dialogVisible).toBeTrue();
    expect(component.activeRow).toEqual(row);
    expect(component.dialogTitle).toBe('Land Purchase Loan · TELP');
  });
