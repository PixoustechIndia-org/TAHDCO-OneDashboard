...
describe('Patrol360Component', () => {
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(Patrol360Component);
  ...
  it('should open dialog with row data', () => {
    const row = { division: 'Chennai', district: 'Kanchipuram', value: 100 };
    component.openRowDetail(row);
    expect(component.dialogVisible).toBeTrue();
    expect(component.activeRow).toEqual(row);
    expect(component.dialogTitle).toBe('Kanchipuram · Chennai');
  });
