...
describe('EnrollmentComponent', () => {
  ...
  it('should open dialog with row data', () => {
    const row = { division: 'Chennai', district: 'Kanchipuram', institute: 'ITI Kanchipuram', value: 100 };
    component.openRowDetail(row);
    expect(component.dialogVisible).toBeTrue();
    expect(component.activeRow).toEqual(row);
    expect(component.dialogTitle).toBe('ITI Kanchipuram · Kanchipuram');
  });
